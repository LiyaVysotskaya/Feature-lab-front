...
import PopupPrivacyPolicyPortal from './PopupPrivacyPolicyPortal/PopupPrivacyPolicyPortal';
...
export const PopupPrivacyPolicy: React.FC<PopupPrivacyPolicyProps> = ({ isOpen, onClose }) => {
  return (
    <PopupPrivacyPolicyPortal onClose={onClose} isOpen={isOpen}>
      <div className={s.popup}>
        ...
        <div className={s.popupPrivacyPolicy__wrapper}>
          ...
          <p className={s.popupFootnote}>в отношении обработки персональных данных</p>
        </div>
        <div className={s.popupPrivacyPolicy__content}>
            ...
            <div className={s.popupPrivacyPolicy__content_item_text}>
              ...
              <div>
                ...
                <p>
                  ...
                  посетителях веб-сайта https:// featurelab.ru.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className={s.popupPrivacyPolicy__content_item_text}>
              <div>
                ...
                <p>
                  ...
                  сетевому адресу https:// featurelab.ru.
                </p>
                <p>
              ...
              <div>
                <p>
                  ...
                  к определённому или определяемому Пользователю веб-сайта https:// featurelab.ru.
                </p>
                <p>
                  ...
                  лиц к которым предоставлен субъектом персональных данных путём дачи согласия
                  на обработку персональных данных, разрешённых субъектом персональных данных
                  для распространения в порядке, предусмотренном Законом о персональных данных
                  (далее — персональные данные, разрешённые для распространения).
                </p>
                <p>2.10. Пользователь — любой посетитель веб-сайта https:// featurelab.ru.</p>
                <p>
                ...
                <p>
                  ...
                  на раскрытие персональных данных неопределённому кругу лиц (передача персональных
          ...
          <div className={s.popupPrivacyPolicy__content_item}>
            <div className={s.popupPrivacyPolicy__content_item_title}>
              ...
              <p className={s.popupPrivacyPolicy__content_item_title_text}>
                <span>Основные права</span>
                <span>и обязанности Оператора</span>
              </p>
            </div>
            <div className={s.popupPrivacyPolicy__content_item_text}>
              <div>
          ...
          <div className={s.popupPrivacyPolicy__content_item}>
            <div className={s.popupPrivacyPolicy__content_item_title}>
              ...
              <p className={s.popupPrivacyPolicy__content_item_title_text}>
                <span>Основные права</span>
                <span>и обязанности субъектов персональных данных</span>
              </p>
            </div>
            <div className={`${s.popupPrivacyPolicy__content_item_text} ${s.one_column}`}>
              <div>
                ...
                <p>
                  ...
                  её получения установлен Законом о персональных данных;
                </p>
                <p>
            ...
            <div className={s.popupPrivacyPolicy__content_item_text}>
              ...
              <div>
                <p>
                  ...
                  к целям обработки персональных данных. Оператор принимает необходимые меры и/или
            ...
            <div className={s.popupPrivacyPolicy__content_item_text}>
              <div>
                ...
                <p>
                  ...
                  для осуществления возложенных законодательством Российской Федерации на оператора
            ...
            <div className={s.popupPrivacyPolicy__content_item_text}>
              <div>
                ...
                <p>
                  ...
                  актуализировать их самостоятельно, путём направления Оператору уведомление
                  на адрес электронной почты Оператора featurelab.ru@yandex.ru с пометкой
                ...
                <p>
                  ...
                  отозвать своё согласие на обработку персональных данных, направив Оператору
                  уведомление посредством электронной почты на электронный адрес Оператора
                  featurelab.ru@yandex.ru с пометкой «Отзыв согласия на обработку персональных
                  данных».
                </p>
              </div>
              <div>
          ...
          <div className={s.popupPrivacyPolicy__content_item}>
            <div className={s.popupPrivacyPolicy__content_item_title}>
              <p className={s.popupPrivacyPolicy__content_item_title_number}>10</p>
              <p className={s.popupPrivacyPolicy__content_item_title_text}>
            ...
            <div className={s.popupPrivacyPolicy__content_item_text}>
              <div>
                ...
                персональных данных о своём намерении осуществлять трансграничную передачу
          ...
          <div className={s.popupPrivacyPolicy__content_item}>
            <div className={s.popupPrivacyPolicy__content_item_title}>
              <p className={s.popupPrivacyPolicy__content_item_title_number}>11</p>
              <p className={s.popupPrivacyPolicy__content_item_title_text}>
          ...
          <div className={s.popupPrivacyPolicy__content_item}>
            <div className={s.popupPrivacyPolicy__content_item_title}>
              <p className={s.popupPrivacyPolicy__content_item_title_number}>12</p>
              <p className={s.popupPrivacyPolicy__content_item_title_text}>
            ...
            <div className={`${s.popupPrivacyPolicy__content_item_text} ${s.one_column}`}>
              <div>
                <p>
                  ...
                  электронной почты featurelab.ru@yandex.ru.
                </p>
                <p>
