...
export const ProfileTabsNav: React.FC = () => {
    ...
    <>
      <nav aria-label="Меню личного кабинета" className={cl(s.nav)}>
        <ul className={cl(s.list)}>
          ...
          <li className={cl(s.listItem)}>
            <ProfileTabLink to={ROUTE_PROFILE_DOCS} icon={<FolderOpenIcon />} text="Документы" />
          </li>

          <li className={cl(s.listItem)}>
            <ProfileTabLink to={ROUTE_PROFILE_SETTINGS} icon={<GearSixIcon />} text="Профиль" />
          </li>
