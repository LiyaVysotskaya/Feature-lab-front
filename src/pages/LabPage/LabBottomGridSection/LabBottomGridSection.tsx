...
export const LabBottomGridSection: FC<IProps> = ({ className = '' }) => {
  return (
    <section className={cl(s.section, className)}>
      ...
      <LabText
        text={`За что нас выбирают? \n\nЗакрываем индивидуальные пробелы в знаниях на практике с приобретением опыта взаимодействия как с нишевыми специалистами своей области, так и смежными командами.`}
