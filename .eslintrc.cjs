module.exports = {
  ...
  rules: {
    ...
    'react/function-component-definition': [2, { namedComponents: 'arrow-function' }], // better for consistency
    ...
    'import/no-extraneous-dependencies': 0, // we know better where to install packages
